describe('Store Form Test', () => {
    it('Submit without puting all the data', () => {
        ...
        cy.get('[id="inputNumber-Street Number"]').type('12');
        cy.get('[name="submitButton"]').click();
        cy.contains('Create a new store');
    ...
    it('Submit puting data in wrong format', () => {
        ...
        cy.get('[id="inputNumber-Street Number"]').type('123456789X123456789X123456');
        ...
        cy.get('[id="inputNumber-Street Number"]').should('have.css', 'background-color','rgb(254, 202, 202)').parent().should('contain', 'Set a number');
        ...
        cy.get('[id="inputNumber-Street Number"]').clear().should('have.css', 'background-color','rgb(254, 202, 202)').parent().should('contain', 'Set a number');
        cy.get('[id="inputNumber-Street Number"]').type('1').should('have.css', 'background-color','rgb(249, 250, 251)').parent().should('not.contain', 'Set a number');
